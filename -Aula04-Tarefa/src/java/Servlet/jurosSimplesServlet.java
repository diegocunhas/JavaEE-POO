...
public class jurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            double vl = Double.parseDouble(request.getParameter("value"));
            double t = Double.parseDouble(request.getParameter("duration"));
            double i = Double.parseDouble(request.getParameter("interest"));
            double res = vl*(1+t*i/100);
            out.println("<p>O valor de "+vl+" reais aplicado por "+t+" meses a "
                    + "uma taxa de juros simples, de "+i+" % renderá:");
            out.printf("%.2f%n",res);
            out.println(" reais </p>");
            out.println("</body>");
            out.println("</html>");
