...
public class MathServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2><a href='.'>Retornar a página anterior</a></h2>");
            try{
                ...
                out.println("<h3>ADIÇÃO = "+(n1+n2)+"</h3>");
                out.println("<h3>SUBTRAÇÃO = "+(n1-n2)+"</h3>");
                out.println("<h3>MULTIPLICAÇÃO = "+(n1*n2)+"</h3>");
                out.println("<h3>DIVISÃO = "+(n1/n2)+"</h3>");
            }catch(Exception ex){
